...
export function buildDemoWorkspace(uid: string): DemoWorkspaceData {
  ...
  const atlasMaps: AtlasMap[] = [
    {
      ...
      style: {
        ...
        background: { type: 'preset', preset: 'grid', opacity: 0.26, blur: 0 },
        fontFamily: 'system',
        nodeStyle: 'card',
        showWeakLinks: false,
      },
    ...
    },
    {
      ...
      style: {
        ...
        customLineColor: '#f59e0b',
        background: { type: 'preset', preset: 'paper', opacity: 0.82, blur: 0 },
        fontFamily: 'serif',
        nodeStyle: 'pill',
        showWeakLinks: true,
      },
  ...
  const goal: GoalSettings = {
    ...DEFAULT_GOAL_SETTINGS,
    label: 'Reviewer Demo Intellectual Commitments',
    targets: { book: 6, paper: 4, article: 8, podcast: 6, video: 6, movie: 2, documentary: 2, audiobook: 2 },
    goalTypes: [
      { id: 'goal-source-consumption', name: 'Source Consumption', mediaTypes: ['book', 'paper', 'article', 'podcast', 'video', 'lecture', 'conversation'], sortOrder: 0, createdAt: iso(1), updatedAt: iso(24) },
      { id: 'goal-inquiry-development', name: 'Inquiry Development', mediaTypes: [], sortOrder: 1, createdAt: iso(1), updatedAt: iso(24) },
      { id: 'goal-position-review', name: 'Position Review', mediaTypes: [], sortOrder: 2, createdAt: iso(1), updatedAt: iso(24) },
      { id: 'goal-work-expression', name: 'Writing Output', mediaTypes: [], sortOrder: 3, createdAt: iso(1), updatedAt: iso(24) },
      { id: 'goal-practice-testing', name: 'Practice Completion', mediaTypes: [], sortOrder: 4, createdAt: iso(1), updatedAt: iso(24) },
    ],
    goals: [
      {
        id: 'goal-sources-demo',
        title: 'Study sources that change a live question',
        typeId: 'goal-source-consumption',
        goalKind: 'consumption',
        currentProgress: 9,
        targetProgress: 18,
        sortOrder: 0,
        status: 'active',
        purpose: 'Use sources as inputs for changing concepts, inquiries, positions, works, and practices.',
        reason: 'The demo workspace should show how reading becomes philosophical movement instead of a completion counter.',
        evidenceOfProgress: 'Completed sources include annotations, concept tags, and downstream connections.',
        completionCriteria: 'Eighteen sources have connected annotations and a short reflection about what changed.',
        ...
        linkedObjectLabels: ['Inquiry: Can attention be treated as a moral responsibility?', 'Concept: Attention', 'Position: Attention is the root material of agency.'],
        reviewCadence: 'weekly',
        reviewNotes: [`${iso(20)}: Source work is producing useful pressure on the attention and technology positions.`],
        lastReviewAt: iso(20),
        createdAt: iso(1),
        updatedAt: iso(24),
      },
      {
        id: 'goal-inquiries-demo',
        title: 'Move serious inquiries toward provisional answers',
        typeId: 'goal-inquiry-development',
        goalKind: 'inquiry',
        currentProgress: 4,
        targetProgress: 8,
        sortOrder: 1,
        status: 'active',
        purpose: 'Keep recurring questions from becoming vague background noise.',
        reason: 'Inquiries should become framed investigations with evidence, assumptions, and decision points.',
        evidenceOfProgress: 'An inquiry gains evidence, subquestions, unknowns, or a provisional answer.',
        completionCriteria: 'Eight inquiries are resolved, transformed, or deliberately suspended with a summary.',
        ...
        linkedObjectLabels: ['Inquiry: Does discipline increase freedom or reduce it?', 'Unknown: Whether discipline can become another form of avoidance.'],
        reviewCadence: 'weekly',
        createdAt: iso(1),
        updatedAt: iso(24),
      },
      {
        id: 'goal-positions-demo',
        title: 'Review and stress-test current positions',
        typeId: 'goal-position-review',
        goalKind: 'position',
        currentProgress: 5,
        targetProgress: 10,
        sortOrder: 2,
        status: 'under_review',
        purpose: 'Make beliefs editable by testing their evidence, scope, assumptions, and strongest objections.',
        reason: 'Positions are the center of gravity; they should not remain unchallenged declarations.',
        evidenceOfProgress: 'A position receives support, challenge, confidence change, revision, or abandonment.',
        completionCriteria: 'Ten positions have been reviewed and either kept, revised, challenged, abandoned, or transformed.',
        ...
        linkedObjectLabels: ['Position: A belief is not mature until it survives a serious challenge.', 'Position: Technology should be judged by what it trains the user to become.'],
        reviewCadence: 'monthly',
        reviewNotes: [`${iso(18)}: Technology and comfort positions need better opposing evidence before they should be treated as stable.`],
        lastReviewAt: iso(18),
        createdAt: iso(1),
        updatedAt: iso(24),
      },
      {
        id: 'goal-practices-demo',
        title: 'Turn positions into lived tests',
        typeId: 'goal-practice-testing',
        goalKind: 'practice',
        currentProgress: 3,
        targetProgress: 6,
        sortOrder: 3,
        status: 'active',
        purpose: 'Prevent philosophy from staying decorative by making positions answer to behavior.',
        reason: 'Practices close the loop between thought and life.',
        evidenceOfProgress: 'A practice has logs, observations, and a stated consequence for a linked position or inquiry.',
        completionCriteria: 'Six practices have produced an outcome note and a linked intellectual consequence.',
        milestones: ['Choose the idea or position being tested.', 'Define the hypothesis and observation method.', 'Perform the practice long enough to gather evidence.', 'Complete a theory-versus-reality review.', 'Update the linked position, inquiry, or unknown.'],
        linkedObjectLabels: ['Practice: Daily attention audit', 'Position: The strongest ideas are those that can become practices.'],
        reviewCadence: 'weekly',
        createdAt: iso(1),
        updatedAt: iso(24),
      },
  ...
  atlasMaps.push({
    ...
    style: {
      ...
      customLineColor: '#fbbf24',
      background: { type: 'preset', preset: 'dark', opacity: 0.48, blur: 0 },
      fontFamily: 'rounded',
      nodeStyle: 'default',
      showWeakLinks: false,
    },
